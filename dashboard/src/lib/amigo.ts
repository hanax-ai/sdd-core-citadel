...
export const GATEKEEPER_FINDINGS = [
  {
    line: 15,
    severity: "resolved",
    text: "Lock must be module-level singleton — fixed in round 2.",
  },
  { line: 44, severity: "resolved", text: "Missing timeout on refresh await — wait_for added." },
  {
    line: 40,
    severity: "note",
    text: "Double-checked locking is intentional; documented in test.",
  },
];

export const RUN_LOGS = [
  {
    file: "20260731T0212_auth-race.json",
  ...
  {
    file: "20260730T1841_rls-policies.json",
  ...
  {
    file: "20260730T1102_cli-flags.json",
  ...
  {
    file: "20260729T2033_evidence-cache.json",
...
export const RAID: {
  ...
  },
  {
    id: "R-02",
    type: "Risk",
    title: "Large evidence payloads exceed context window",
    owner: "Claude",
    severity: "Medium",
    status: "Open",
  },
  {
    id: "A-01",
    type: "Assumption",
    title: "Target repos remain read-only under propose-only model",
    owner: "Program",
    severity: "High",
    status: "Validated",
  },
  ...
  },
  {
    id: "D-01",
    type: "Dependency",
    title: "ANTHROPIC / OPENAI / GEMINI keys present in environment",
    owner: "Ops",
    severity: "High",
    status: "Satisfied",
  },
  {
    id: "D-02",
    type: "Dependency",
    title: "Bridge API exposing /api/stream and /api/run-task",
    owner: "Harness",
    severity: "High",
    status: "In Progress",
  },
